window.onload = function () {
     ...
     * 
     * 3. getHint: Will be used to store the hint for the word to be
     *              guessed by user.
     * 
     * 4. word: Will be used to store the word to be guessed by user.
     * 
     * 5. guess: Will be used to store the letter that the user guesses.
     * 
     * 6. geusses: Will be used to store the letters that the user guesses.
     * 
     * 7. lives: Will be used to store the number of lives that the user
     *              has left.
     * 
     * 8. counter: Will be used to store the number of correct guesses
     *              that the user has made.
     * 
     * 9. space: Will be used to store the number of spaces in the word
